...
import { approveAppointment, bookAppointment, endAppoinment, getActiveAppointment, getAppointmentDetails, getAppointmentsRequestsForDoctor, getPrevAppoinments, rejectAppointment } from "./appointment.controler";
